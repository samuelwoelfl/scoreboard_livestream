            ...
            <div class="scores">
                <div class="group_score">
                    <div class="counter group">
                        <input type="number" class="score" id="A_Score_Team" value="0" database-variable></input>
                    </div>
                    <div class="counter group">
                        <input type="number" class="score" id="B_Score_Team" value="0" database-variable></input>
                    </div>
                </div>
